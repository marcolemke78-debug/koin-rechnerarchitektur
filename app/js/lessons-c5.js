  ...
  // ===== LEKTION 12: IP-Grundlagen & Multiple Choice =====
  {
    ...
    explanation: {
      html:
        ...
        + '</ul>'
        + '<div class="tip-box">'
        + '<strong>Fachbegriff \u201EOktett\u201C:</strong> Eine IPv4-Adresse besteht aus 4 Teilen, getrennt durch Punkte. Jeder dieser Teile ist ein <em>Oktett</em> \u2013 also 8 Bit bzw. dezimal 0\u2013255. Beispiel: in <code>192.168.5.100</code> ist <code>168</code> das zweite Oktett.'
        + '</div>'
  ...
  // ===== LEKTION 15: Netzwerk-IDs berechnen =====
  {
    ...
    explanation: {
      html:
        ...
        + '</ul>'
        + '<div class="tip-box">'
        + '<strong>Klausur-Shortcut:</strong> Bei /8, /16 oder /24 musst du gar nicht bin\u00e4r rechnen. /24 = die ersten drei Oktette bleiben, das vierte wird 0. F\u00fcr /16 entsprechend die ersten zwei. Nur bei \u201Ekrummen\u201C Masken (/27, /25, /19) brauchst du wirklich AND in Bin\u00e4r.'
        + '</div>'
        + '<div class="why-context">'
