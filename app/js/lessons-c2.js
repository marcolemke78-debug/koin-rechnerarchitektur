  ...
  // ===== LEKTION 7: Binärsystem & Subtraktion =====
  {
    ...
    explanation: {
      html:
        ...
        + '<strong>Borgen-Kette:</strong> Wenn du aus einer Stelle borgen musst, die selbst 0 ist, muss das Borgen <em>weiter nach links</em> durchgereicht werden \u2013 bis eine 1 kommt. Das l\u00e4sst eine Kette 0\u21921 und 1\u21920 zur\u00fcck. Langsam Stelle f\u00fcr Stelle arbeiten.'
        + '</div>'
  ...
  // ===== LEKTION 8: Halbsubtrahierer =====
  {
    ...
    explanation: {
      html:
        ...
        + '</table>'
        + '<div class="warning-box">'
        + '<strong>Nicht verwechseln:</strong> Halbaddierer (HA) und Halbsubtrahierer (HS) sehen fast identisch aus. Unterschied: HS hat bei <code>0\u22121</code> ein <em>Borgen</em> (<code>B_out = 1</code>) und liefert D = 1; HA hat bei <code>1+1</code> ein <em>Carry</em> (<code>C_out = 1</code>) und liefert S = 0. Beide nutzen XOR f\u00fcr die Ausgangs-Stelle.'
        + '</div>'
        + '<div class="why-context">'
  ...
  // ===== LEKTION 9: Vollsubtrahierer =====
  {
    ...
    explanation: {
      html:
        ...
        + '</table>'
        + '<div class="warning-box">'
        + '<strong>Zwei Borgen-Ausg\u00e4nge im Vollsubtrahierer:</strong> Intern gibt es <em>zwei</em> Borgen-Signale (aus den beiden Halbsubtrahierern). Der externe <code>B_out</code> ist das <strong>OR</strong> dieser beiden. Vertausche die Rollen nicht \u2013 typischer Punkte-Verlust in der Klausur.'
        + '</div>'
        + '<div class="why-context">'
  ...
  // ===== LEKTION 10: Addierwerk 4-Bit =====
  {
    ...
    explanation: {
      html:
        ...
        + '<div class="warning-box">'
        + '<strong>Overflow bei 4 Bit:</strong> Das 4-Bit-Addierwerk kann nur Ergebnisse bis 15 (unsigned) bzw. +7\u2009/\u2009\u22128 (ZK) darstellen. Darunter/dar\u00fcber: der Carry-Out signalisiert <em>\u00dcberlauf</em>, die 4 Bits sind dann falsch. In der Klausur: Carry-Out immer mitlesen!'
        + '</div>'
        + '<div class="why-context">'
  ...
  // ===== LEKTION 11: SR-Riegel & Timing-Diagramme =====
  {
    ...
    explanation: {
      html:
        ...
        + '</div>'
        + '<div class="warning-box">'
        + '<strong>Verbotener Zustand &amp; Metastabilit\u00e4t:</strong> <code>S=1, R=1</code> bei <code>C=1</code> ist <em>unzul\u00e4ssig</em>: Setzen und R\u00fccksetzen gleichzeitig widerspricht sich, der Ausgang wird <em>metastabil</em> (schwebt zwischen 0 und 1). In der Klausur immer als \u201Everboten\u201C markieren.'
        + '</div>'
        + '<div class="why-context">'
