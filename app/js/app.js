...
const LESSONS = [
  ...
  // C1 – Schaltalgebra
  { id: 1,  module: 'c1', title: 'Schaltkreise lesen & umwandeln', examRelevant: true },
  { id: 2,  module: 'c1', title: 'Logische Operatoren: AND, OR, NOT, XOR' },
  { id: 3,  module: 'c1', title: 'Wahrheitstabelle aus Ausdruck erstellen', examRelevant: true },
  { id: 4,  module: 'c1', title: 'Disjunktive Normalform (DNF) ableiten', examRelevant: true },
  { id: 5,  module: 'c1', title: 'Äquivalenz mit Wahrheitstabellen beweisen', examRelevant: true },
  { id: 6,  module: 'c1', title: 'Gatterschaltungen zeichnen & lesen', examRelevant: true },
  // C2 – Binärarithmetik & Sequenzielle Logik
  { id: 7,  module: 'c2', title: 'Binärsystem & Subtraktion' },
  { id: 8,  module: 'c2', title: 'Halbsubtrahierer', examRelevant: true },
  { id: 9,  module: 'c2', title: 'Vollsubtrahierer', examRelevant: true },
  { id: 10, module: 'c2', title: 'Addierwerk 4-Bit' },
  { id: 11, module: 'c2', title: 'SR-Riegel & Timing-Diagramme', examRelevant: true },
  // C5 – Rechnernetze I
  { id: 12, module: 'c5', title: 'IP-Grundlagen' },
  { id: 13, module: 'c5', title: 'IP-Adressen validieren', examRelevant: true },
  { id: 14, module: 'c5', title: 'Subnetzmasken & binäre Schreibweise', examRelevant: true },
  { id: 15, module: 'c5', title: 'Netzwerk-IDs berechnen', examRelevant: true },
  { id: 16, module: 'c5', title: 'Subnetting Praxis (/27, Broadcast)', examRelevant: true },
  // C6 – Rechnernetze II
  { id: 17, module: 'c6', title: 'DNS & IP im Internet finden', examRelevant: true },
  { id: 18, module: 'c6', title: 'Netzwerkstruktur & Wahr/Falsch', examRelevant: true },
  { id: 19, module: 'c6', title: 'IP-Adressen im Netz prüfen', examRelevant: true },
  { id: 20, module: 'c6', title: 'Routing-Tabellen ausfüllen', examRelevant: true },
