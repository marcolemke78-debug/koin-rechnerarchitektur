  ...
  // ===== LEKTION 2: Logische Operatoren: AND, OR, NOT, XOR =====
  {
    ...
    explanation: {
      html:
        ...
        + '<strong>Klausur-Fallstrick NAND:</strong> NAND ist <em>nicht</em> <code>\u00aca \u2227 \u00acb</code>, sondern <code>\u00ac(a \u2227 b)</code> (die Negation steht au\u00dfen!). Genauso NOR = <code>\u00ac(a \u2228 b)</code>. Wer das verwechselt, verliert reihenweise Punkte bei DeMorgan-Aufgaben.'
        + '</div>'
        + '<div class="why-context">'
  ...
  // ===== LEKTION 3: Wahrheitstabelle aus Ausdruck erstellen =====
  {
    ...
    explanation: {
      html:
        ...
        + '</ol>'
        + '<div class="tip-box">'
        + '<strong>Klausur-Tipp:</strong> Schreibe <em>immer</em> Hilfsspalten mit (z.\u202FB. f\u00fcr \u00acb, x = a\u2228b, y = a\u2227\u00acb). Jede Zwischenspalte ist ein Kontrollpunkt \u2013 und oft werden sie ausdr\u00fccklich verlangt. Kein Nachweis = kein Punkt.'
        + '</div>'
        + '<div class="why-context">'
  ...
  // ===== LEKTION 4: Disjunktive Normalform (DNF) ableiten =====
  {
    ...
    explanation: {
      html:
        ...
        + '<div class="warning-box">'
        + '<strong>Typischer DNF-Fehler:</strong> Steht in einer Zeile eine Variable = 0, musst du sie <em>negiert</em> in den Minterm schreiben (<code>\u00aca</code>). Sie einfach wegzulassen ergibt einen v\u00f6llig anderen Ausdruck. Regel: Variable = 1 \u2192 direkt, Variable = 0 \u2192 negiert.'
        + '</div>'
        + '<div class="why-context">'
  ...
  // ===== LEKTION 6: Gatterschaltungen zeichnen & lesen =====
  {
    ...
    explanation: {
      html:
        ...
        + '<div class="warning-box">'
        + '<strong>Klausur-Pflicht:</strong> In dieser Klausur gelten nur die <strong>IEC-60617-12-Symbole</strong> (Rechtecke mit &, \u22651, 1; Negation als Kreis am Ausgang). US-Symbole (D-f\u00f6rmiges AND, geschwungenes OR) geben Punktabzug.'
        + '</div>'
        + '<div class="why-context">'
